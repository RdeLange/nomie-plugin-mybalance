<script>
  ...
  let loading = true;
  let view = "main";
  const mbisinit = [{label:"Breathe",color:"#ED2527",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Hydrate",color:"#3DB549",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Sleep",color:"#2289B4",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Eat",color:"#F79321",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Move",color:"#94AFDC",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Connect",color:"#FF5F75",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Learn",color:"#00ADEF",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Reflect",color:"#935FA7",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0}]
  let mbis = [];
...
function showMain(){
 ...
 function saveEdit(){
  startCalculation();
  const tempcheck = [{label:"Breathe",color:"#ED2527",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Hydrate",color:"#3DB549",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Sleep",color:"#2289B4",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Eat",color:"#F79321",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
   {label:"Move",color:"#94AFDC",scale:0.0,calculated:false,calculations:[],calculatedscale:0.0},
